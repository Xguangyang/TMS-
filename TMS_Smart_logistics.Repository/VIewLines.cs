...
namespace TMS_Smart_logistics.Repository
{
    public class VIewLines : Base<Model.VIewLine>, ICircuitAdministration
    {
        ...
        int ICircuitAdministration.AddLines(VIewLine obj)
        {
            throw new NotImplementedException();
        }

        int ICircuitAdministration.DelLines(string CircuitAdministrationID)
        {
            throw new NotImplementedException();
        }

        int ICircuitAdministration.UpdLines(VIewLine onj)
        {
            throw new NotImplementedException();
        }
    }
